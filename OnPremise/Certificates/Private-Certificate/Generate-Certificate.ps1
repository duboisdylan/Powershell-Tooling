...
Process {
    ...
    $mycert | Export-PfxCertificate -FilePath "..\..\..\_Ressources\$($DnsName.Split(".")[0]).pfx" -Password $SecurePassword

    # Export certificate to .cer file
    $mycert | Export-Certificate -FilePath "..\..\..\_Ressources\$($DnsName.Split(".")[0]).cer"
}
